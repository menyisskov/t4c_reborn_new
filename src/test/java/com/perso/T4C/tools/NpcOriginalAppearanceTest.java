...
class NpcOriginalAppearanceTest {
    ...
    void keepsSimpleAndMultipartAppearancesDistinct() {
        ...
        assertEquals(List.of("BODY:WoWhiteRobe", "FEET:WoLeatherBoots", "WEAPON:PupWoodenStaff"), parts(moonrock));
    }

    @Test
    void restoresExactNpcSpecificEquipmentInsteadOfGenericDefaults() {
        assertEquals(List.of(
                "BODY:PupChainMailBody", "FEET:PupPlateFoot", "LEFT_HAND:PupLeatherGloveL",
                "RIGHT_HAND:PupLeatherGloveR", "LEGS:PupLeatherPants"),
                parts(NpcOriginalAppearance.forName("Markam")));
        assertEquals(List.of(
                "BODY:PupLeatherBody", "FEET:PupLeatherBoots", "LEFT_HAND:PupLeatherGloveL",
                "RIGHT_HAND:PupLeatherGloveR", "LEGS:PupStuddedLegs", "WEAPON:PupBattleSword",
