...
public final class ARENAMOBXP100 extends DataMonster {
  ...
  public ARENAMOBXP100(MonsterDef definition, float worldX, float worldY) throws GameException {
  ...
  public static MonsterDef definition() {
    return new MonsterDef(
        ...
        104,
        35,
        new int[] {70, 70, 46, 93, 70, 5000, 100, 100, 100, 100, 100, 100},
        100,
        410,
        0,
        1112014848,
        ...
        0,
        true,
        java.util.List.of(new MonsterDef.Attack("1d 172 + 134 ", 1210, 30, 0, 0, 0)),
        false,
        0,
        java.util.List.of(),
        java.util.Map.ofEntries(
            ...
            java.util.Map.entry(
                "@spell.spell.mob_arena_level_spell", "GiveFlag(__FLAG_ARENA_LEVEL,100)")));
  }
}
