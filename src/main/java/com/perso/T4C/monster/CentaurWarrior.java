  ...
  public static MonsterDef definition() {
    return new MonsterDef(
        ...
        java.util.List.of(
            ...
            new MonsterDef.LootDrop("centaur_slaying_armor", 0.002f),
            new MonsterDef.LootDrop("centaur_slaying_boots", 0.002f),
            new MonsterDef.LootDrop("centaur_slaying_gauntlets", 0.002f),
            new MonsterDef.LootDrop("centaur_slaying_helmet", 0.002f),
            new MonsterDef.LootDrop("centaur_slaying_leggings", 0.002f),
            new MonsterDef.LootDrop("centaur_slaying_protector", 0.002f),
            new MonsterDef.LootDrop("centaur_slaying_quiver", 0.002f)),
        false,
        0.0f,
        130,
        120,
