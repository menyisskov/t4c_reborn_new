...
public final class ARENAMOBXP375 extends DataMonster {
  ...
  public ARENAMOBXP375(MonsterDef definition, float worldX, float worldY) throws GameException {
  ...
  public static MonsterDef definition() {
    return new MonsterDef(
        ...
        352,
        90,
        new int[] {94, 94, 94, 94, 94, 5000, 100, 100, 100, 100, 100, 100},
        375,
        1510,
        0,
        1127940096,
        ...
        0,
        true,
        java.util.List.of(new MonsterDef.Attack("1d 644 + 506 ", 4510, 20, 0, 0, 0)),
        false,
        0,
        java.util.List.of(),
        java.util.Map.ofEntries(
            ...
            java.util.Map.entry(
                "@spell.spell.mob_arena_level_spell", "GiveFlag(__FLAG_ARENA_LEVEL,375)")));
  }
}
