...
public final class ARENAMOBXP475 extends DataMonster {
  public static final String SOUND_ATTACK = "Beast Attack.wav";
  public static final String SOUND_DEATH = "Beast Dying.wav";
  public static final String SOUND_HIT = "Beast Hit.wav";

  public ARENAMOBXP475(MonsterDef definition, float worldX, float worldY) throws GameException {
  ...
  public static MonsterDef definition() {
    return new MonsterDef(
        ...
        0,
        true,
        java.util.List.of(new MonsterDef.Attack("1d 816 + 641 ", 5710, 10, 0, 0, 0)),
        false,
        0,
        java.util.List.of(),
        java.util.Map.ofEntries(
            ...
            java.util.Map.entry(
                "@spell.spell.mob_arena_level_spell", "GiveFlag(__FLAG_ARENA_LEVEL,475)")));
  }
}
