...
public final class KAHPLETHGUARD21 extends DataMonster {
  ...
  public static final String CANONICAL_NAME = "KAHPLETHGUARD21";

  public KAHPLETHGUARD21(MonsterDef definition, float x, float y) throws GameException {
