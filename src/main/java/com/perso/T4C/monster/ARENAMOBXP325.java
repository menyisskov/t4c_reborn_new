...
public final class ARENAMOBXP325 extends DataMonster {
  ...
  public ARENAMOBXP325(MonsterDef definition, float worldX, float worldY) throws GameException {
  ...
  public static MonsterDef definition() {
    return new MonsterDef(
        ...
        0,
        true,
        java.util.List.of(new MonsterDef.Attack("1d 559 + 438 ", 3910, 20, 0, 0, 0)),
        false,
        0,
        java.util.List.of(),
        java.util.Map.ofEntries(
            ...
            java.util.Map.entry(
                "@spell.spell.mob_arena_level_spell", "GiveFlag(__FLAG_ARENA_LEVEL,325)")));
  }
}
