  ...
  public static MonsterDef definition() {
    return new MonsterDef(
        ...
        java.util.List.of(
            ...
            // The Sunken Chancel's own water/dark intelligence set (Drowned Inquisition,
            // ArmorSetGenerator) - its boss is the main source; Drowned Acolytes drop it rarely.
            new MonsterDef.LootDrop("drowned_inquisition_armor", 0.04f),
            new MonsterDef.LootDrop("drowned_inquisition_boots", 0.04f),
            new MonsterDef.LootDrop("drowned_inquisition_gauntlets", 0.04f),
            new MonsterDef.LootDrop("drowned_inquisition_helmet", 0.04f),
            new MonsterDef.LootDrop("drowned_inquisition_leggings", 0.04f),
            new MonsterDef.LootDrop("drowned_inquisition_protector", 0.04f)),
        false,
        0.0f,
        60,
        58,
