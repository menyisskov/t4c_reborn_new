...
public class ItemDefinition {
  ...
  public ItemDefinition(
    ...
    this(
        ...
        localRespawn,
        spells,
        Collections.<ItemBoost>emptyList(),
        Collections.<ContainerLootGroup>emptyList(),
        false);
  }
  ...
  public ItemDefinition(
      ...
      List<ItemSpell> spells,
      List<ItemBoost> boosts,
      List<ContainerLootGroup> containerLootGroups) {
    this(
        key,
        name,
        bodyPart,
  ...
  public ItemDefinition(
    ...
    this.containerLootGroups =
        containerLootGroups != null ? List.copyOf(containerLootGroups) : Collections.emptyList();
