...
public class DecorRenderer {
  ...
  private final java.util.ArrayDeque<DecorRenderItem> renderItemPool =
      new java.util.ArrayDeque<>(2048);
  ...
  public DecorRenderer(
      ...
      Set<String> flaggedDecorNames) {
    this.reader = reader;
    this.spriteLoader = spriteLoader;
    this.batchDecor = batchDecor;
    this.metaByName = metaByName;
    this.flaggedDecorNames =
        (flaggedDecorNames == null ? java.util.Collections.emptySet() : flaggedDecorNames);
  ...
  public void renderDecorConditionalInternal(
      int startX, int endX, int startY, int endY, float playerY, boolean drawIfAbovePlayer) {
  ...
  public void collectDecorsInFrontOfPlayer(
      java.util.List<ObjectRenderer.RenderItem> items,
      Deque<ObjectRenderer.RenderItem> pool,
      int startX,
      int endX,
      int startY,
      int endY,
  ...
  public void collectDecorsInArea(
      java.util.List<ObjectRenderer.RenderItem> items,
      Deque<ObjectRenderer.RenderItem> pool,
      int startX,
      int endX,
  ...
  private DecorCache getDecorCache(String spriteName) {
    ...
    return decorCacheByName.computeIfAbsent(
        spriteName,
        name -> {
  ...
  private DecorTileCache getDecorTileCache(int x, int y) {
    ...
    DecorCache decor =
        resolved != null && resolved.name != null ? getDecorCache(resolved.name) : null;
