...
/** Shared collision-cell overlay rendering. */
public final class CollisionOverlayRenderer {
    private CollisionOverlayRenderer() { }

    public static void render(ShapeRenderer renderer, int startX, int endX, int startY, int endY,
                              BiPredicate<Integer, Integer> blocked, BiFunction<Integer, Integer, float[]> color) {
