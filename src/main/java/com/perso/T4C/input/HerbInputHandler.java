...
/** Converts world hover/click input into herb harvesting requests. */
public final class HerbInputHandler extends InputAdapter {
    ...
    public HerbInputHandler(OrthographicCamera camera, HerbManager herbs, Predicate<HerbNode> startHarvest) {
        this.camera = camera;
        this.herbs = herbs;
