...
/**
 * Temporary map zone display that fades in/out over a fixed duration.
 */
public class GuiMapZoneDisplay {
     ...
     * @return true if still visible, false if finished.
     */
    public boolean render(SpriteBatch batch, float delta) {
        ...
        Color outlineColor = new Color(outlineBaseColor.r, outlineBaseColor.g, outlineBaseColor.b, alpha);
