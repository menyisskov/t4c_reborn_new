...
/** Sprite-backed two-state checkbox. */
public class GuiCheckbox extends AbstractGuiElement implements GuiResizable {
    ...
    public GuiCheckbox(TextureRegion on, TextureRegion onHover, TextureRegion off, TextureRegion offHover,
                       float x, float y, BooleanSupplier value, Consumer<Boolean> setter) {
        super(x, y);
        this.on = on;
    ...
    /** Resizes the boxed zone while keeping the toggle sprite centered inside it. */
    ...
    public void render(SpriteBatch batch) {
        ...
        if (region != null) {
            GuiDraw.drawRegionFlipped(batch, region,
