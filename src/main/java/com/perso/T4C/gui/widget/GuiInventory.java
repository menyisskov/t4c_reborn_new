...
/**
 * Class representing GuiInventory.
 */
 ...
 */
    ...
    public ItemHit hitTest(float screenX, float screenY) {
        ...
        if (screenX < innerX || screenX > innerX + innerW || screenY < innerY || screenY > innerY + innerH) {
            return null;
        }
        ...
        for (StackEntry stack : stacks(items)) {
            ...
            if (screenX >= cursorX && screenX <= cursorX + w && screenY >= cursorY && screenY <= cursorY + h) {
    ...
    private static final class StackEntry {
        final String itemName; final int firstIndex; final int count;
        StackEntry(String itemName, int firstIndex, int count) {
            this.itemName = itemName; this.firstIndex = firstIndex; this.count = count;
        }
    }
