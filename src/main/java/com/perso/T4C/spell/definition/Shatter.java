...
public final class Shatter {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        2,
        "100",
        "1000+if((680-(self.level-18)*20)>=0?(680-(self.level-18)*20):0)",
        "750+if((680-(self.level-18)*20)>=0?(680-(self.level-18)*20):0)",
        "750+if((680-(self.level-18)*20)>=0?(680-(self.level-18)*20):0)",
        30073,
        0,
        true,
            ...
            new SpellData.T4cEffect(
                ...
                List.of(
                    new SpellData.T4cEffect.EffectParam(
                        1, "-((1d5+26+self.wis/17)*self.earth/target.r_earth)"),
