...
public final class Tsunami {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        2,
        "100",
        "1000+if((1460-(self.level-96)*20)>=0?(1460-(self.level-96)*20):0)",
        "750+if((1460-(self.level-96)*20)>=0?(1460-(self.level-96)*20):0)",
        "750+if((1460-(self.level-96)*20)>=0?(1460-(self.level-96)*20):0)",
        30085,
        0,
        true,
            ...
            new SpellData.T4cEffect(
                ...
                List.of(
                    new SpellData.T4cEffect.EffectParam(
                        1, "-((1d65+93+self.int/7)*self.water/target.r_water)"),
