...
public final class ItemHyperPotionOfNimbleness {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        null, 10180, 3, 5, 1,
        "100", "0", "0", "0",
        0, 0, false, List.of(new SpellData.T4cEffect(2, List.of(new SpellData.T4cEffect.EffectParam(1, null), new SpellData.T4cEffect.EffectParam(2, "Agility"), new SpellData.T4cEffect.EffectParam(3, "if(self.true_agi/4<50?50:self.true_agi/4)")))));
  }
}
