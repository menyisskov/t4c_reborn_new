...
public final class Inferno {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        2,
        "100",
        "1000+if((1330-(self.level-83)*20)>=0?(1330-(self.level-83)*20):0)",
        "750+if((1330-(self.level-83)*20)>=0?(1330-(self.level-83)*20):0)",
        "750+if((1330-(self.level-83)*20)>=0?(1330-(self.level-83)*20):0)",
        30121,
        0,
        true,
            ...
            new SpellData.T4cEffect(
                ...
                List.of(
                    new SpellData.T4cEffect.EffectParam(
                        1, "-((1d76+89+self.int/8)*self.fire/target.r_fire)"),
