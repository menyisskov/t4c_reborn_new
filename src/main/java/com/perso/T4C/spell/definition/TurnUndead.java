...
public final class TurnUndead {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        2,
        "100",
        "1000+if((690-(self.level-19)*20)>=0?(690-(self.level-19)*20):0)",
        "750+if((690-(self.level-19)*20)>=0?(690-(self.level-19)*20):0)",
        "750+if((690-(self.level-19)*20)>=0?(690-(self.level-19)*20):0)",
        30096,
        0,
        true,
            ...
            new SpellData.T4cEffect(
                ...
                List.of(
                    new SpellData.T4cEffect.EffectParam(
                        1,
                        "-(((1d6+27+self.wis/16)*self.light/target.r_light)*self.wis/(20+2*self.level))"),
