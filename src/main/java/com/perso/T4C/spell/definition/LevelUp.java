        ...
        List.of(
            new SpellData.T4cEffect(
                ...
                List.of(
                    ...
                    new SpellData.T4cEffect.EffectParam(3, "self.str/10"))),
            new SpellData.T4cEffect(
                2,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, null),
                    new SpellData.T4cEffect.EffectParam(2, "agility"),
                    new SpellData.T4cEffect.EffectParam(3, "self.agi/10"))),
            new SpellData.T4cEffect(
                2,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, null),
                    new SpellData.T4cEffect.EffectParam(2, "endurance"),
                    new SpellData.T4cEffect.EffectParam(3, "self.end/10"))),
            new SpellData.T4cEffect(
                2,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, null),
                    new SpellData.T4cEffect.EffectParam(2, "intelligence"),
                    new SpellData.T4cEffect.EffectParam(3, "self.int/10"))),
            new SpellData.T4cEffect(
                2,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, null),
                    new SpellData.T4cEffect.EffectParam(2, "wisdom"),
                    new SpellData.T4cEffect.EffectParam(3, "self.wis/10")))));
  }
}
