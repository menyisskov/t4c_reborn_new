        ...
        List.of(
            new SpellData.T4cEffect(
                ...
                List.of(
                    ...
                    new SpellData.T4cEffect.EffectParam(2, "if(self.viewflag(30552)<1?1:3)"))),
            new SpellData.T4cEffect(
                7,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, "871+1d4"),
                    new SpellData.T4cEffect.EffectParam(2, "2083+1d8"),
