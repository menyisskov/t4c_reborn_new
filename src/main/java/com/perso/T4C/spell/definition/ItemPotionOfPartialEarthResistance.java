...
public final class ItemPotionOfPartialEarthResistance {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        null, 10287, 0, 5, 1,
        "100", "0", "0", "0",
        0, 0, false, List.of(new SpellData.T4cEffect(2, List.of(new SpellData.T4cEffect.EffectParam(1, null), new SpellData.T4cEffect.EffectParam(2, "r_earth"), new SpellData.T4cEffect.EffectParam(3, "self.true_r_earth/2")))));
  }
}
