...
public final class ItemPotionOfRegeneration {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        null, 10110, 0, 5, 1,
        "100", "0", "0", "0",
        0, 0, false, List.of(new SpellData.T4cEffect(9, List.of(new SpellData.T4cEffect.EffectParam(1, "10113"), new SpellData.T4cEffect.EffectParam(2, "OnTimer"), new SpellData.T4cEffect.EffectParam(3, "100")))));
  }
}
