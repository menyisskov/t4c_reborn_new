...
public final class ItemPotionOfTranquility {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        null, 10158, 0, 5, 2,
        "100", "0", "0", "0",
        0, 0, false, List.of(new SpellData.T4cEffect(2, List.of(new SpellData.T4cEffect.EffectParam(1, "TRUE"), new SpellData.T4cEffect.EffectParam(2, "Wisdom"), new SpellData.T4cEffect.EffectParam(3, "10")))));
  }
}
