        ...
        List.of(
            new SpellData.T4cEffect(
                ...
                List.of(
                    ...
                    new SpellData.T4cEffect.EffectParam(2, "end"),
                    new SpellData.T4cEffect.EffectParam(3, "-(target.end/2)"))),
            new SpellData.T4cEffect(
                2,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, null),
                    new SpellData.T4cEffect.EffectParam(2, "agi"),
                    new SpellData.T4cEffect.EffectParam(3, "-(target.agi/2)"))),
            new SpellData.T4cEffect(
                2,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, null),
                    new SpellData.T4cEffect.EffectParam(2, "str"),
                    new SpellData.T4cEffect.EffectParam(3, "-(target.str/2)")))));
  }
}
