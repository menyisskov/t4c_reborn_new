...
public final class MobStoneSpell {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        "Rocks Fly.wav",
        0,
        "if(target.end>=500?10000:20000-(target.end*20))",
        "0",
        233,
        null,
        10388,
        ...
        List.of(
            new SpellData.T4cEffect(
                ...
                List.of(
                    new SpellData.T4cEffect.EffectParam(
                        1, "if(target.end>=500?10000:20000-(target.end*20))"),
                    new SpellData.T4cEffect.EffectParam(2, null),
                    new SpellData.T4cEffect.EffectParam(
                        3, "if(target.end>=500?10000:20000-(target.end*20))"),
            ...
            new SpellData.T4cEffect(
                ...
                List.of(
                    ...
                    new SpellData.T4cEffect.EffectParam(3, "if(self.ac<50?50:self.ac)")))));
  }
}
