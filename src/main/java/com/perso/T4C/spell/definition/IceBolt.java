...
public final class IceBolt {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        1,
        "100",
        "1000+if((750-(self.level-25)*20)>=0?(750-(self.level-25)*20):0)",
        "750+if((750-(self.level-25)*20)>=0?(750-(self.level-25)*20):0)",
        "750+if((750-(self.level-25)*20)>=0?(750-(self.level-25)*20):0)",
        30023,
        0,
        true,
            ...
            new SpellData.T4cEffect(
                ...
                List.of(
                    new SpellData.T4cEffect.EffectParam(
                        1, "-((1d39+31+self.int/15)*self.water/target.r_water)"),
