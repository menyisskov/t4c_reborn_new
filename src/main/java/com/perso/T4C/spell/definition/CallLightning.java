...
public final class CallLightning {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        2,
        "100",
        "1000+if((760-(self.level-26)*20)>=0?(760-(self.level-26)*20):0)",
        "750+if((760-(self.level-26)*20)>=0?(760-(self.level-26)*20):0)",
        "750+if((760-(self.level-26)*20)>=0?(760-(self.level-26)*20):0)",
        30087,
        0,
        true,
            ...
            new SpellData.T4cEffect(
                ...
                List.of(
                    new SpellData.T4cEffect.EffectParam(
                        1, "-((1d37+20+self.int/30+self.wis/30)*self.air/target.r_air)"),
