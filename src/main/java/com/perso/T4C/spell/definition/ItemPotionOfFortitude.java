...
public final class ItemPotionOfFortitude {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        null, 10156, 0, 5, 2,
        "100", "0", "0", "0",
        0, 0, false, List.of(new SpellData.T4cEffect(2, List.of(new SpellData.T4cEffect.EffectParam(1, "TRUE"), new SpellData.T4cEffect.EffectParam(2, "Endurance"), new SpellData.T4cEffect.EffectParam(3, "10")))));
  }
}
