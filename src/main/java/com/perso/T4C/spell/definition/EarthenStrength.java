...
public final class EarthenStrength {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        "64kSpellEnergyBallGreen-", "RockyFly-", 0, 0,
        "Healing.wav", "Rocks Fly.wav", 0, "300000", "0", 26329,
        null, 10124, 2, 3, 1,
        ...
        30113, 0, false, List.of(new SpellData.T4cEffect(2, List.of(new SpellData.T4cEffect.EffectParam(1, "TRUE"), new SpellData.T4cEffect.EffectParam(2, "strength"), new SpellData.T4cEffect.EffectParam(3, "(10+self.wis/15+self.int/20)")))));
  }
}
