    ...
    return new SpellData(
        ...
        List.of(
            new SpellData.T4cEffect(
                ...
                List.of(
                    ...
                    new SpellData.T4cEffect.EffectParam(
                        3,
                        "if(equipcount(41555)+equipcount(41556)+equipcount(41557)+equipcount(41558)+equipcount(41559)+equipcount(41560)<6?(equipcount(41555)+equipcount(41556)+equipcount(41557)+equipcount(41558)+equipcount(41559)+equipcount(41560))*5:50)"))),
            new SpellData.T4cEffect(
                2,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, null),
                    ...
                    new SpellData.T4cEffect.EffectParam(
                        3,
                        "if(equipcount(41555)+equipcount(41556)+equipcount(41557)+equipcount(41558)+equipcount(41559)+equipcount(41560)<6?(equipcount(41555)+equipcount(41556)+equipcount(41557)+equipcount(41558)+equipcount(41559)+equipcount(41560))*4:40)"))),
            new SpellData.T4cEffect(
                2,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, null),
            ...
            new SpellData.T4cEffect(
                9,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, "10488"),
                    new SpellData.T4cEffect.EffectParam(2, "OnHit"),
                    new SpellData.T4cEffect.EffectParam(3, "100"),
                    new SpellData.T4cEffect.EffectParam(4, "250"))),
            new SpellData.T4cEffect(
                9,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, "10719"),
            ...
            new SpellData.T4cEffect(
                ...
                List.of(
                    ...
                    new SpellData.T4cEffect.EffectParam(3, "-(self.maxmana/10)")))));
  }
}
