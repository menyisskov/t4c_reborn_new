...
public final class ItemScrollOfDetectInvisible {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        1,
        "100",
        "1000+if((1000-(self.level-50)*20)>=0?(1000-(self.level-50)*20):0)",
        "750+if((1000-(self.level-50)*20)>=0?(1000-(self.level-50)*20):0)",
        "750+if((1000-(self.level-50)*20)>=0?(1000-(self.level-50)*20):0)",
        30007,
        0,
        false,
        List.of(
            new SpellData.T4cEffect(
                13,
                List.of(
                    new SpellData.T4cEffect.EffectParam(1, "10258"),
