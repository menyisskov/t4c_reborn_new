...
public final class FireBolt {
  ...
  public static SpellData definition() {
    return new SpellData(
        ...
        1,
        "100",
        "1000+if((720-(self.level-22)*20)>=0?(720-(self.level-22)*20):0)",
        "750+if((720-(self.level-22)*20)>=0?(720-(self.level-22)*20):0)",
        "750+if((720-(self.level-22)*20)>=0?(720-(self.level-22)*20):0)",
        30014,
        0,
        true,
            ...
            new SpellData.T4cEffect(
                ...
                List.of(
                    new SpellData.T4cEffect.EffectParam(
                        1, "-((1d45+31+self.int/16)*self.fire/target.r_fire)"),
