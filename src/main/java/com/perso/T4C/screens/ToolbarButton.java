...
final class ToolbarButton {
    ...
    ToolbarButton(int x, int y, String tooltip, String icon, Runnable action, Color accentColor,
            BooleanSupplier activeSupplier) {
    ...
    void render(SpriteBatch batch, ShapeRenderer shapeRenderer, BitmapFont font) {
        ...
        font.draw(batch, shortcut, bounds.x + (bounds.width - shortcutLayout.width) / 2f,
        ...
        font.draw(batch, label, bounds.x + (bounds.width - labelLayout.width) / 2f, bounds.y + 15f + bump);
