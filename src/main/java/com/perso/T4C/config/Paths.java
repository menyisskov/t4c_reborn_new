...
/**
 * Centralized application paths to avoid hard-coded strings throughout the codebase.
 */
public final class Paths {
    private Paths() {}

    public static final String SHADERS_OUTLINE_VERT = "assets/shaders/outline.vert";
    public static final String SHADERS_OUTLINE_FRAG = "assets/shaders/outline.frag";
    ...
    public static final String SPRITE_BIN = "assets/sprites/sprites.bin";
    public static final String SPRITE_BIN_V2 = "assets/sprites/sprites2.bin";
