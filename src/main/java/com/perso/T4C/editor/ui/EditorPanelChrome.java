...
public final class EditorPanelChrome {
  ...
  public static void panel(
      ShapeRenderer renderer, Rectangle bounds, Color accent, float headerHeight) {
  ...
  public static void selectedRow(
      ShapeRenderer renderer, Rectangle listBounds, int localRow, float rowHeight) {
  ...
  public static void button(
      ShapeRenderer renderer, Rectangle bounds, boolean active, boolean disabled) {
    if (disabled) {
  ...
  public static void buttonText(
      SpriteBatch batch, BitmapFont font, Rectangle bounds, String label, Color color) {
