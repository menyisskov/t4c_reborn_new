...
public final class PortalJ3 extends ScriptedNpc {
  ...
  public static final String ID = "PortalJ3";

  public static final String DISPLAY_NAME = "${npc.portalj3}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.portalj3}",
          List.of(),
          "PortalNPC",
          new NpcSpec.CombatProfile(100, 1000000, 500, 500, 500, 1000000, 1, 65535, "1d3"));

  public PortalJ3(NpcContext context) throws GameException {
  ...
  private static final NpcBehavior BEHAVIOR =
      new PortalBehavior(2822, 2593, 0, 4, "${npc.welcome.portalj3}");
}
