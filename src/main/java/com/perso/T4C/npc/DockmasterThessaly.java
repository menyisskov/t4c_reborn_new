...
// T4C-0024: the last real dock on this stretch of coast (1670,2660), worldZ 0, near the existing
// CaptainIronleg/CorsairMagere pirate NPCs - gives "passage_to_kraanhold" (see quest/definition/
// PassageToKraanhold.java), the access quest that unlocks fast travel to Windhowl Marches, the
// entrance province of Kraanhold (T4C-0024's new continent). Without this quest a fresh character
// has no route there at all - Kraanhold was painted into open ocean this pass, with no existing
// road or NPC anywhere near it, the same dead-end Avalon had before T4C-0019's HarbormasterRangor.
@Spawn(type = "DockmasterThessaly", x = 1670, y = 2660, z = 0, stationary = false, aggressive = false)
