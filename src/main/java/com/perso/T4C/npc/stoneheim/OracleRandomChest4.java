...
@Spawn(
    type = "OracleRandomChest4",
    x = 2796,
    y = 2466,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleRandomChest4 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleRandomChest4";

  public static final String DISPLAY_NAME = "${npc.oraclerandomchest4}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oraclerandomchest4}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleRandomChest4(NpcContext context) throws GameException {
