...
@Spawn(type = "CryptChest3", x = 561, y = 1061, z = 1, stationary = true, aggressive = false)
public final class CryptChest3 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "CryptChest3";

  public static final String DISPLAY_NAME = "${npc.cryptchest3}";
  ...
  protected NpcBehavior javaBehavior() {
    ...
    return new NpcBehavior() {
      ...
      public void onConversationStart(NpcBehaviorContext c) {
        ...
        if (s == 3 && !c.hasItem("crumbling_bone_key")) {
  ...
  public CryptChest3(NpcContext context) throws GameException {
