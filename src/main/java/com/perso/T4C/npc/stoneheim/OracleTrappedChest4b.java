...
@Spawn(
    type = "OracleTrappedChest4b",
    x = 2814,
    y = 2298,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest4b extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest4b";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest4b}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest4b}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest4b(NpcContext context) throws GameException {
