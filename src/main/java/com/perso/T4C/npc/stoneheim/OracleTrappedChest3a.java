...
@Spawn(
    type = "OracleTrappedChest3a",
    x = 2836,
    y = 2264,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest3a extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest3a";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest3a}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest3a}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest3a(NpcContext context) throws GameException {
