...
public final class OracleRandomChest5 extends ScriptedNpc {
  ...
  public static final String ID = "OracleRandomChest5";

  public static final String DISPLAY_NAME = "${npc.oraclerandomchest5}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oraclerandomchest5}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleRandomChest5(NpcContext context) throws GameException {
