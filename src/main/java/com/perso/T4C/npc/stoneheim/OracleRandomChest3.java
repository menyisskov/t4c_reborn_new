...
@Spawn(
    type = "OracleRandomChest3",
    x = 2792,
    y = 2462,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleRandomChest3 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleRandomChest3";

  public static final String DISPLAY_NAME = "${npc.oraclerandomchest3}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oraclerandomchest3}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleRandomChest3(NpcContext context) throws GameException {
