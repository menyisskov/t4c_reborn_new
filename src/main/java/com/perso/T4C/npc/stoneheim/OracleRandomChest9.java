...
@Spawn(
    type = "OracleRandomChest9",
    x = 2816,
    y = 2486,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleRandomChest9 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleRandomChest9";

  public static final String DISPLAY_NAME = "${npc.oraclerandomchest9}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oraclerandomchest9}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleRandomChest9(NpcContext context) throws GameException {
