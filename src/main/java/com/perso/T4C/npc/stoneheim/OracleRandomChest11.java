...
@Spawn(
    type = "OracleRandomChest11",
    x = 2824,
    y = 2494,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleRandomChest11 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleRandomChest11";

  public static final String DISPLAY_NAME = "${npc.oraclerandomchest11}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oraclerandomchest11}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleRandomChest11(NpcContext context) throws GameException {
