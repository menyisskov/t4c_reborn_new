...
@Spawn(
    type = "OracleRandomChest1",
    x = 2784,
    y = 2454,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleRandomChest1 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleRandomChest1";

  public static final String DISPLAY_NAME = "${npc.oraclerandomchest1}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oraclerandomchest1}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleRandomChest1(NpcContext context) throws GameException {
