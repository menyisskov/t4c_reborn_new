...
@Spawn(
    type = "OracleTrappedChest6a",
    x = 2860,
    y = 2264,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest6a extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest6a";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest6a}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest6a}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest6a(NpcContext context) throws GameException {
