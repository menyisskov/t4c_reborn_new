...
@Spawn(
    type = "OracleTrappedChest7b",
    x = 2784,
    y = 2328,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest7b extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest7b";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest7b}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest7b}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest7b(NpcContext context) throws GameException {
