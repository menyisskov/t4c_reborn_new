...
@Spawn(
    type = "OracleTrappedChest1a",
    x = 2866,
    y = 2246,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest1a extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest1a";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest1a}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest1a}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest1a(NpcContext context) throws GameException {
