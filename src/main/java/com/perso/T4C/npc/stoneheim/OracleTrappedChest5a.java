...
@Spawn(
    type = "OracleTrappedChest5a",
    x = 2848,
    y = 2276,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest5a extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest5a";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest5a}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest5a}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest5a(NpcContext context) throws GameException {
