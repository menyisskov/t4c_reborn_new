...
@Spawn(
    type = "OracleTrappedChest4a",
    x = 2830,
    y = 2282,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest4a extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest4a";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest4a}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest4a}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest4a(NpcContext context) throws GameException {
