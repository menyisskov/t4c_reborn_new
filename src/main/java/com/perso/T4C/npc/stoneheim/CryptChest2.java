...
@Spawn(type = "CryptChest2", x = 558, y = 1068, z = 1, stationary = true, aggressive = false)
public final class CryptChest2 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "CryptChest2";

  public static final String DISPLAY_NAME = "${npc.cryptchest2}";
  ...
  protected NpcBehavior javaBehavior() {
    ...
    return new NpcBehavior() {
      ...
      public void onConversationStart(NpcBehaviorContext c) {
        ...
        if (s == 2 && !c.hasItem("crumbling_bone_key")) {
  ...
  public CryptChest2(NpcContext context) throws GameException {
