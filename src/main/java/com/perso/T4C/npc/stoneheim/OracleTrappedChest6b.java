...
@Spawn(
    type = "OracleTrappedChest6b",
    x = 2796,
    y = 2328,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest6b extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest6b";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest6b}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest6b}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest6b(NpcContext context) throws GameException {
