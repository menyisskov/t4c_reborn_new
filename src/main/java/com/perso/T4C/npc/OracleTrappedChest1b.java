...
@Spawn(
    type = "OracleTrappedChest1b",
    x = 2778,
    y = 2334,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest1b extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest1b";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest1b}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest1b}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest1b(NpcContext context) throws GameException {
