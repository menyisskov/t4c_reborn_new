...
@Spawn(type = "CryptChest1", x = 560, y = 1075, z = 1, stationary = true, aggressive = false)
public final class CryptChest1 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "CryptChest1";

  public static final String DISPLAY_NAME = "${npc.cryptchest1}";
  ...
  protected NpcBehavior javaBehavior() {
    ...
    return new NpcBehavior() {
      ...
      public void onConversationStart(NpcBehaviorContext c) {
        ...
        if (s == 1 && !c.hasItem("crumbling_bone_key")) {
  ...
  public CryptChest1(NpcContext context) throws GameException {
