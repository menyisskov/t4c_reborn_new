...
@Spawn(
    type = "OracleRandomChest10",
    x = 2820,
    y = 2490,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleRandomChest10 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleRandomChest10";

  public static final String DISPLAY_NAME = "${npc.oraclerandomchest10}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oraclerandomchest10}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleRandomChest10(NpcContext context) throws GameException {
