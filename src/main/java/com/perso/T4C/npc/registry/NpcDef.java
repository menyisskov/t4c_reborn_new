...
public final class NpcDef {
  ...
  public NpcDef(
    ...
    this.sourceEvents =
        java.util.Map.copyOf(sourceEvents == null ? java.util.Map.of() : sourceEvents);
  }

  @Deprecated
  public List<TaughtSpell> getTaughtSpells() {
  ...
  @Deprecated
  public List<TrainableStat> getTrainableStats() {
  ...
  public NpcDef(
      ...
      String spriteBase,
      int patrolRadiusTiles,
      List<TaughtSpell> ignoredSpells,
      List<ShopItem> ignoredItems,
      List<TrainableStat> ignoredStats,
      List<String> fleeShouts,
      List<DialogNode> legacyNodes) {
    ...
    this(
        ...
        legacyNodes == null
            ? ""
            : legacyNodes.stream()
                .filter(DialogNode::isGreeting)
                .map(DialogNode::getResponse)
                .findFirst()
                .orElse(""),
        legacyNodes == null
            ? List.of()
            : legacyNodes.stream()
                ...
                .map(
                    node ->
                        new DialogTopic(node.getKeywords(), node.getResponse(), node.getActions()))
                .toList());
  }
  ...
  public static final class Action {
    ...
    public Action(
        ActionType type,
        String stringParam1,
        String ignoredStringParam2,
        int ignoredIntParam1,
        int ignoredIntParam2) {
