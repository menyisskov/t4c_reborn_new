...
@Spawn(
    type = "OracleTrappedChest2b",
    x = 2784,
    y = 2316,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest2b extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest2b";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest2b}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest2b}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest2b(NpcContext context) throws GameException {
