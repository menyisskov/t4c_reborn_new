...
@Spawn(
    type = "OracleRandomChest2",
    x = 2788,
    y = 2458,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleRandomChest2 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleRandomChest2";

  public static final String DISPLAY_NAME = "${npc.oraclerandomchest2}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oraclerandomchest2}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleRandomChest2(NpcContext context) throws GameException {
