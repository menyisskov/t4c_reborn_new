...
@Spawn(
    type = "OracleTrappedChest5b",
    x = 2808,
    y = 2316,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest5b extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest5b";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest5b}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest5b}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest5b(NpcContext context) throws GameException {
