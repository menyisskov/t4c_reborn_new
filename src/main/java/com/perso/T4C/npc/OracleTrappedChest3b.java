...
@Spawn(
    type = "OracleTrappedChest3b",
    x = 2796,
    y = 2304,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest3b extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest3b";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest3b}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest3b}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest3b(NpcContext context) throws GameException {
