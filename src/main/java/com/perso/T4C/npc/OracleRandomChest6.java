...
@Spawn(
    type = "OracleRandomChest6",
    x = 2804,
    y = 2474,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleRandomChest6 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleRandomChest6";

  public static final String DISPLAY_NAME = "${npc.oraclerandomchest6}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oraclerandomchest6}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleRandomChest6(NpcContext context) throws GameException {
