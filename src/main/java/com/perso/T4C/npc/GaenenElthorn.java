...
public final class GaenenElthorn extends ScriptedNpc {
  ...
  public static final String ID = "GaenenElthorn";

  public static final String DISPLAY_NAME = "${npc.gaenenelthorn}";
  ...
  protected NpcBehavior javaBehavior() {
    ...
    return new NpcBehavior() {
      ...
      public void onHit(com.perso.T4C.npc.behavior.NpcBehaviorContext c) {
        ...
        int stamp = c.npcFlag("GAENEN_CAN_BE_HIT");

        if (stamp == 0 || now - stamp >= 300) {

          stamp = (int) now;

          c.npcFlag("GAENEN_CAN_BE_HIT", stamp);
        ...
        if (c.flag("__FLAG_CHARACTER_CAN_HIT_ASSISTANT") != stamp) {
          ...
          c.systemMessageKey("npc.gaenenelthorn.cannot_hit");
        ...
        if (c.player().getCurrentHp() < 50) {
          ...
          if (c.npcCurrentHp() > 750000) c.castSelfSpell(10717);
            ...
            c.sayKey("npc.gaenenelthorn.defeated");
  ...
  public GaenenElthorn(NpcContext context) throws GameException {
