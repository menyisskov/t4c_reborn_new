...
@Spawn(
    type = "OracleRandomChest8",
    x = 2812,
    y = 2482,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleRandomChest8 extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleRandomChest8";

  public static final String DISPLAY_NAME = "${npc.oraclerandomchest8}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oraclerandomchest8}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleRandomChest8(NpcContext context) throws GameException {
