...
@Spawn(
    type = "OracleTrappedChest7a",
    x = 2860,
    y = 2252,
    z = 2,
    stationary = true,
    aggressive = false)
public final class OracleTrappedChest7a extends ScriptedNpc {
  public static final String SOUND_ATTACK = "Whooshh 1.wav";
  public static final String SOUND_DEATH = "Male Dying 1.wav";
  public static final String SOUND_HIT = "Male Hit 1.wav";

  public static final String ID = "OracleTrappedChest7a";

  public static final String DISPLAY_NAME = "${npc.oracletrappedchest7a}";
  ...
  private static final NpcSpec SPEC =
      new NpcSpec(
          ...
          0,
          List.of(),
          "${npc.welcome.oracletrappedchest7a}",
          List.of(),
          "OracleChestNPC",
  ...
  public OracleTrappedChest7a(NpcContext context) throws GameException {
