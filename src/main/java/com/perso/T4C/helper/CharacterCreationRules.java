...
public final class CharacterCreationRules {
    ...
    /**
     * Rolls original-scale level-one attributes. Questionnaire affinities bias a roll but every
     * attribute keeps a random component, preserving the classic reroll step.
     */
    ...
    public record Stats(int strength, int endurance, int dexterity, int wisdom,
                        int intelligence, int maxHp, int maxMana) {
    }
}
