...
/**
 * Original T4C server collision/area values stored in four bits per map tile.
 */
@Getter
...
public enum CollisionType {
    ...
    FULL_PVP_NO_DROP_CAST(15, "Full PvP no drop/cast", false, false, new Color(0.52f, 0.05f, 0.32f, 0.65f));
