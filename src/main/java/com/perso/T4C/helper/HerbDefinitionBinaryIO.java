...
/** Versioned binary serialization for harvestable herb definitions. */
public final class HerbDefinitionBinaryIO {
    ...
    public static List<HerbDefinition> read(File file) throws IOException, GameException {
        return BinaryCatalogueIO.read(file, MAGIC, "herb definition", version -> {
            if (version != VERSION) throw new GameException("Unsupported herb definition version: " + version);
    ...
    public static void write(File file, List<HerbDefinition> definitions) throws IOException {
        BinaryCatalogueIO.write(file, MAGIC, VERSION, definitions, HerbDefinitionBinaryIO::writeDefinition);
    }

    private static HerbDefinition readDefinition(DataInputStream in, short version) throws IOException {
    ...
    private static void writeDefinition(DataOutputStream out, HerbDefinition definition) throws IOException {
