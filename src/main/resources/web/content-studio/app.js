...
const sectionGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "skills", label: "Skill Editor", endpoint: "/api/skills", key: "id", subtitle: "minimumLevel" },
...
const fields = {
  ...
  skills: ["id", "minimumLevel:number", "minimumStrength:number", "minimumEndurance:number", "minimumAgility:number", "minimumIntelligence:number", "minimumWisdom:number", "learningCost:number", "useCooldownMillis:number", "prerequisites:textarea"],
...
const FIELD_META = {
  ...
  minimumLevel: ["Minimum level", "Player level required to learn this skill."],
  minimumStrength: ["Minimum strength", "Strength required to learn this skill."],
  minimumEndurance: ["Minimum endurance", "Endurance required to learn this skill."],
  minimumAgility: ["Minimum agility", "Agility required to learn this skill."],
  minimumIntelligence: ["Minimum intelligence", "Intelligence required to learn this skill."],
  minimumWisdom: ["Minimum wisdom", "Wisdom required to learn this skill."],
  learningCost: ["Learning cost", "Skill points spent when first learning this skill."],
  useCooldownMillis: ["Use cooldown (ms)", "Cooldown applied after an explicit activation of this skill, in milliseconds."],
  prerequisites: ["Prerequisites", "One \"skillId:level\" per line: other skills that must already be at that level before this one can be learned."],
