...
**Next free ID: `T4C-0016`.** When starting new work, claim the next ID,
...
| T4C-0015 | Monster balance report generator (audit new bosses vs. legacy curve) | Process/Tooling | In Progress | | |
